...
_TIER1_RULES["injury"] = [
    ...
    _phrase("fall / mobility",
            ...
            "leg is broken"),
    _phrase("burn / thermal injury",
            "burnt my hand", "burned my hand", "burnt my", "burned my",
            "i burnt", "i burned", "got burned", "got burnt",
            "phone on fire", "phone caught fire", "phone in flames",
            "skin is burned", "burn on my hand"),
